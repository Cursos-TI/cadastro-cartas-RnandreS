...
int main()
{
    ...
    float area_carta_um,pib_carta_um,densidade_carta_um,per_capta_carta_um;
    ...
    float area_carta_dois,pib_carta_dois,densidade_carta_dois,per_capta_carta_dois;
    ...
    per_capta_carta_um = (float) pib_carta_um / populacao_carta_um;
    densidade_carta_dois  = (float) populacao_carta_dois / area_carta_dois; 
    per_capta_carta_dois = (float) pib_carta_dois / populacao_carta_dois;
